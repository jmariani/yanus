 ...
 * in a grid view.
 * Also uses the {@link KeenDataProvider} extension to limit the number of requests
 * to the database.
 *
 ...
 *                      (from dropdown for instance) \*\/
 *                    'fieldwithdifferentsearchvalue'=>array('field'=>'device.displayname','searchvalue'=>'deviceid'),
        ...
        if($this->getOwner()->getScenario()==='search') {
            ...
            if(isset($this->relations[$key])) {
                ...
                if(is_array($relationvar)) {
                    ...
                    $relationfield=$relationvar['field'];
                    $search_value=CHtml::value($this->getOwner(),$relationfield);
                } else {
