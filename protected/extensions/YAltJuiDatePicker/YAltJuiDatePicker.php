...
/**
 * YAltJuiDatePicker displays a datepicker.
 *
 * YAltJuiDatePicker encapsulates the {@link http://jqueryui.com/demos/datepicker /JUI
 * datepicker} plugin.
 *
 * To use this widget, you may insert the following code in a view:
 * <pre>
 * $this->widget('zii.widgets.jui.YAltJuiDatePicker', array(
 *     'name'=>'publishDate',
 ...
 * @since 1.1
 */
class YAltJuiDatePicker extends CJuiInputWidget
{
	/**
	...
	/**
	 * @var array The default options called just one time per request. This options will alter every other YAltJuiDatePicker instance in the page.
	 * It has to be set at the first call of YAltJuiDatePicker widget in the request.
	 */
