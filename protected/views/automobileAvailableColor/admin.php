...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('automobile-available-color-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('application.extensions.PageSize.PageSize', array(
        'mGridId'=>'automobile-available-color-grid',
...
<?php $this->widget('bootstrap.widgets.BootGridView',array(
	'id'=>'automobile-available-color-grid',
	...
	'columns'=>array(
		...
		array(
				'name'=>'Color_id',
				'value'=>'GxHtml::valueEx($data->color)',
				'filter'=>GxHtml::listDataEx(Color::model()->findAllAttributes(null, true)),
				),
		array(
					'name' => 'active',
		...
		array(
					'name' => 'availableForInterior',
					'value' => '($data->availableForInterior == 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
					'filter' => array('0' => Yii::t('app', 'No'), '1' => Yii::t('app', 'Yes')),
					),
		array(
					'name' => 'availableForExterior',
					'value' => '($data->availableForExterior == 0) ? Yii::t(\'app\', \'No\') : Yii::t(\'app\', \'Yes\')',
					'filter' => array('0' => Yii::t('app', 'No'), '1' => Yii::t('app', 'Yes')),
					),
                array(
