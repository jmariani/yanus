<div class="view">
	<?php echo GxHtml::encode($data->getAttributeLabel('invoice')); ?>:
	<?php echo GxHtml::link(GxHtml::encode($data->invoice), array('view', 'id' => $data->id)); ?>
	<br />
<!--
...
<!--	<?php echo GxHtml::encode($data->getAttributeLabel('serial')); ?>:
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('paymentTerm')); ?>:
	<?php echo GxHtml::encode($data->paymentTerm); ?>
	<br />
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('dtsOriginalString')); ?>:
	<?php echo GxHtml::encode($data->dtsOriginalString); ?>
	<br />
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('creationDt')); ?>:
	<?php echo GxHtml::encode($data->creationDt); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('updateDt')); ?>:
	<?php echo GxHtml::encode($data->updateDt); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('status')); ?>:
	<?php echo GxHtml::encode($data->status); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('vendorParty_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->vendorParty)); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('customerParty_id')); ?>:
		<?php echo GxHtml::encode(GxHtml::valueEx($data->customerParty)); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('originalString')); ?>:
	<?php echo GxHtml::encode($data->originalString); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('cbb')); ?>:
	<?php echo GxHtml::encode($data->cbb); ?>
	<br />
	*/ ?>
