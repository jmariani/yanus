<div class="view">
	...
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('plural')); ?>:
	<?php echo GxHtml::encode($data->plural); ?>
	<br />
	<?php echo GxHtml::encode($data->getAttributeLabel('symbol')); ?>:
	<?php echo GxHtml::encode($data->symbol); ?>
	<br />
