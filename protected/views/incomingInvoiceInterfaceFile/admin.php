...
<?php $this->widget('bootstrap.widgets.BootGridView',array(
	...
	'columns'=>array(
		...
		array(
				'name'=>'IncomingInvoiceInterfaceFileStatus_id',
				'value'=>'GxHtml::valueEx($data->incomingInvoiceInterfaceFileStatus)',
				'filter'=>GxHtml::listDataEx(IncomingInvoiceInterfaceFileStatus::model()->findAllAttributes(null, true)),
				),
		'receptionDttm',
                'processDttm',
//		'note',
