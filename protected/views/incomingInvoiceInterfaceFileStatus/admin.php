...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('incoming-invoice-interface-file-status-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('bootstrap.widgets.BootButtonGroup', array(
    'buttons'=>array(
        array('buttonType'=>'link', 'type' => 'primary', 'icon'=>'plus', 'label'=>Yii::t('app', 'Create new' . ' ' . $model->label()), 'url' => array('create')),
...
<?php $this->widget('application.extensions.PageSize.PageSize', array(
        'mGridId'=>'incoming-invoice-interface-file-status-grid',
...
<?php $this->widget('bootstrap.widgets.BootGridView',array(
	'id'=>'incoming-invoice-interface-file-status-grid',
