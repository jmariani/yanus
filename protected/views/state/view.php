...
?><h2><?php echo GxHtml::encode($model->getRelationLabel('registerForms')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->registerForms as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('registerForm/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
		echo GxHtml::closeTag('li');
	}
	echo GxHtml::closeTag('ul');
?>