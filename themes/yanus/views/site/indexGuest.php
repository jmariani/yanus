...
<?php $this->beginWidget('bootstrap.widgets.BootHero', array(
    'heading'=>yii::t('app', 'Welcome!'),
)); ?>

    <p><?php echo yii::t('app', "You're not logged in.");?></p>
    <p><?php echo yii::t('app', "In order to enjoy the benefits of our application, please choose one of the actions listed below.");?></p>
    <?php
